...
def main():
    ...
    input_file = '/home/teto/Scrivania/Tirocinio/DATASETS/nuovo ricerca/JAILBREAK_ANALYZED.json'
    
    # Percorso del file di output
    output_file = '/home/teto/Scrivania/Tirocinio/DATASETS/nuovo ricerca/JAILBREAK_ANALYZED_BIS.json'
    
    # Carica il file JSON
    with open(input_file, 'r', encoding='utf-8') as f:
        data = json.load(f)
    
    # Analizza e aggiorna le etichette
    jailbreak_count = 0
    ...
    for item in data:
        if 'response' in item:
            ...
            # Assegna la nuova etichetta
            new_label = "1" if is_jailbreak else "0"
            
            # Registra se l'etichetta è cambiata
    ...
    print(f"Etichette modificate: {changed_count}")
    print(f"Totale risposte analizzate: {len(data)}")
