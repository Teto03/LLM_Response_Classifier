...
if __name__ == "__main__":
    ...
    # Percorsi completi per i file di input e output
    input_file = os.path.join(script_dir, 'nobrek5000.json')
    output_file = os.path.join(script_dir, 'BREAK_TRANSLATED_5000.json')
    
    translate_json_file(
        input_file,
        output_file,
        translator_type="offline",
        to_lang="en",
        chunk_size=4500,
        delay=2,
        fields_to_translate=["response"]
