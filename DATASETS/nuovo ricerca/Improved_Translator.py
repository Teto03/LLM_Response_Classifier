        ...
        try:
            ...
            for field in fields_to_translate:
                if field in item and item[field]:
                    ...
                    # CORREZIONE: Rinominato segment_text in segment per evitare conflitti di nomi
                    for segment, is_english in segments:
                        if is_english:
                            ...
                            if len(segment) > chunk_size:
                                ...
                                while start < len(segment):
                                    ...
                                    if end < len(segment):
                                        ...
                                        sentence_end = max(segment.rfind('. ', start, end),
...
if __name__ == "__main__":
    translate_json_file(
        'NOBREAKlong.json', # Input file
        'translated_NOBREAKlong_responses.json',  # Output file
